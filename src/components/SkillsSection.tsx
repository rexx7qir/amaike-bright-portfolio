      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Languages & Frameworks I work with to bring ideas to life
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 max-w-5xl mx-auto">
          {skills.map((skill, index) => (
            <motion.div
              ...
              className="glass-card p-6 rounded-2xl flex flex-col items-center justify-center gap-4 cursor-pointer group transition-all duration-300 hover:border-primary/50"
            >
